...
technologies: ["PHP", "Symfony", "CLI", "WordPress"]
description: "A command line tool for setting up WordPress Sites for development. Inspired by the Laravel Installer."
image: "../../assets/images/wordpress-github-installer-cover-image.jpg"
