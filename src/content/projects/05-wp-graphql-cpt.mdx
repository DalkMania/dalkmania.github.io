...
technologies: ["PHP", "WordPress", "GraphQL"]
description: "This plugin builds on top of WP GraphQL and adds all registered custom post types and taxonomies to the WPGraphQL Endpoint."
image: "../../assets/images/wp-graphql-plugin-cover-image.jpg"
