...
skills: ["HTML5", "CSS3", "TypeScript", "React", "Game", "API"]
introparagraph: "A simple React Hangman game. Driven by the Free Dictionary API."
coverimage: "../../assets/images/react-hangman.png"
