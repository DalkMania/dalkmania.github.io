...
skills: ["HTML5", "CSS3", "React", "NextJs", "JavaScript", "CRUD", "Prisma", "Supabase"]
introparagraph: "A simple todo app. Built with NextJs, Supabase and Prisma. "
coverimage: "../../assets/images/nextjs-crud-todo-cover-image.jpg"
githuburl: "https://github.com/DalkMania/nextjs-crud-todo-app"
demourl: "https://dalkmania-nextjs-crud.netlify.app/"
---

import { Image } from "astro:assets";
import LightImage from "../../assets/images/todo-app-light.jpg";
import DarkImage from "../../assets/images/todo-app-dark.jpg";
...
<figure class="figure figure--center">
  <Image
    ...
    format={"webp"}
    aspectRatio={DarkImage.width / DarkImage.height}
  />
...
<figure class="figure figure--center">
  <Image
    ...
    format={"webp"}
    aspectRatio={LightImage.width / LightImage.height}
  />
