...
skills: ["HTML5", "CSS3", "JavaScript", "React", "React Hooks"]
introparagraph: "A simple HTML5 C64 SID Player built with ReactJS, and CSS3. With the help of Create-React-App. This was a learning exercise for me to get into and play around with React and React Hooks."
coverimage: "/assets/images/react-sid-player-cover-image.jpg"
...
<figure class="figure figure--center">
  <Image
    src="/assets/images/react-sid-player-screenshot.jpg"
    alt="React SID Player"
    width={1270}
    format={"webp"}
    aspectRatio={1607 / 839}
  />
  <figcaption class="figure__caption">App screenshot</figcaption>
</figure>
